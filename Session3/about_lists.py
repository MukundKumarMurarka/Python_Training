...
#list comprehension means that creating a newlist by compairing a particular value. for example in the below
#code make a new list with elememts which has n alphates. without using comprehension we use if condition in the for loop
