...
#              Dictionary is mutable and does not support duplicate value
...
pens={"brand":"flair", "model":" write_o_meter","price":20,"country":"india"} #this will change the exixting dictionary
print(pens)
